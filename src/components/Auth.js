      ...
      <section className='mainContainer'>
          ...
          {user && (
            <nav>
              ...
              <div className='background-tabs'>
                <Link to={`/apply-leave`} className="background-tab-link">Apply for Leave</Link>
                <Link to={`/user-sessions/${user.uid}`} className="background-tab-link">View Your Attendance</Link>
              </div>
        ...
        <div className='loginMain'>
          <div className='loginLeft'>
            <h1>Start Your Day with purpose</h1>
            <p>Let’s mark our presence and turn today’s challenges into achievements.</p>
            <button className="signup-button">Lets Go</button>
          </div>
            ...
            <div className='loginBox'>
              ...
              {!user ? (
                ...
                <div className="loggedInContainer">
                  ...
                  <button className="bton" onClick={handleLogout}>
